...
- Date: 2026-09-18T00:37:36+03:00
...
| Latency (median / p95 / max) | 105.28 / 113.43 / 118.26 ms |
...
|---|---|---|
| silence_zeros | PASS | output=no, latency=106.3 ms, next valid frame responded |
| silence_dither | PASS | output=no, latency=105.9 ms, next valid frame responded |
| saturate_max | PASS | output=no, latency=108.2 ms, next valid frame responded |
| saturate_min | PASS | output=silence, latency=92.8 ms, next valid frame responded |
| alternating | PASS | output=silence, latency=118.1 ms, next valid frame responded |
...
| determinism | PASS | 1 distinct result(s) across 10 repetitions; latency jitter=3.24 ms |
...
|---|---|---|---|---|---|---|
| 128 | go_274c008f_nohash_0 | unknown | no | unknown | - | 100.6 |
