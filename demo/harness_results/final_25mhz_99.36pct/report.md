...
- Date: 2026-09-16T19:53:02+03:00
...
| Latency (median / p95 / max) | 106.00 / 113.37 / 117.73 ms |
...
|---|---|---|
| silence_zeros | PASS | output=no, latency=105.8 ms, next valid frame responded |
| silence_dither | PASS | output=no, latency=108.9 ms, next valid frame responded |
| saturate_max | PASS | output=no, latency=111.0 ms, next valid frame responded |
| saturate_min | PASS | output=silence, latency=95.8 ms, next valid frame responded |
| alternating | PASS | output=silence, latency=120.7 ms, next valid frame responded |
...
| determinism | PASS | 1 distinct result(s) across 10 repetitions; latency jitter=0.74 ms |
